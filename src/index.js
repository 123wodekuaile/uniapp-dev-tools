import drawView from "../core/libs/drawView.js";
import logReport from "../core/libs/logReport.js";
import errorReport from "../core/libs/errorReport.js";
import devOptions from "../core/libs/devOptions.js";
import createH5Bubble from "../core/libs/createH5Bubble.js";
import vueMixin from "../core/proxy/vueMixin.js";
import devToolsProxyInstall from "../core/proxy/index.js";
...
// 导出默认配置
const devToolsConfig = devOptions.defaultOptions;

// 导出devTools和devToolsConfig
